...
public class PokerEvaluatorTest {
  ...
  public void testHasHighCard() {
    ...
    assertFalse(calcEval.hasHighCard(calcObj.getUserCards(), calcObj.getCommunityCards()));// no
                                                                                           // highcard
  ...
  public void testHasPair() {
    ...
    assertFalse(calcEval.hasPair(calcObj.getUserCards(), calcObj.getCommunityCards()));
  ...
  public void testHasTwoPairs() {
    ...
    assertFalse(calcEval.hasTwoPairs(calcObj.getUserCards(), calcObj.getCommunityCards()));
  }
