...
public class Hand {
    ...
    private Game game;
    private final static Logger HANDLOGGER = Logger.
    ...
    public Hand(Cards[] cards, Player player) {
        try {
            ...
            HANDLOGGER.log(Level.FINE, "DB Hand creation error", ex);
        }
    }
    ...
    public static Hand findById(int id) {
        ...
        try {
            ...
            HANDLOGGER.log(Level.FINE, "DB find Hand by ID error", ex);
        }
    ...
    public boolean save() {
        ...
        try {
            ...
            HANDLOGGER.log(Level.FINE, "DB save Hand error", ex);
        }
