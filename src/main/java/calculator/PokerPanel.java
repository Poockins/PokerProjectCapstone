...
public class PokerPanel extends JPanel {
    ...
    //
    String[] cardValue = {"TWO", "THREE", "FOUR", "FIVE", "SIX", "SEVEN",
    ...
    private final static Logger POKERPANLOGGER =
            Logger.getLogger("Poker Panel Logger");
    private static Handler fileHandler;
    PokerCalculator pc = new PokerCalculator();
    DBConnection db = new DBConnection();

    String[] columnNames = {"Odds", "Cards"};
    JScrollPane sp;
    Game g = new Game();
    Cards flop[] = new Cards[3];//Three flop cards
    ArrayList<Cards> ffl = new ArrayList<>();
    Cards t; //turn card
    Cards r; //river card
    ArrayList<Cards> p1Cards = new ArrayList<>();//Player 1 cards
    ArrayList<Cards> p2Cards = new ArrayList<>();//Player 2 cards
    //
...
//    PlayerPanelFactory playerFactory = new PlayerPanelFactory();
    ...
    public PokerPanel() {
        try {
            fileHandler = new FileHandler("pokerPanLogger.log", true);
            POKERPANLOGGER.addHandler(fileHandler);
        } catch (IOException exception) {
            POKERPANLOGGER.log(Level.FINER, "FileHandler error.", exception);
        }
        ...
        calcButton.addActionListener((ActionEvent e) -> {
            ...
            pc.probabilityCalculation();
            System.out.println(pc.toString());

            calcPanel.removeAll();
            sp = new JScrollPane(updateTable("1.4%", "any spade", columnNames,
                    calcPanel.getWidth(), calcPanel.getHeight()));
            calcPanel.add(sp);
        });
        ...
        flop1Suit.addActionListener((ActionEvent e) -> {
            ...
            flop[0] = Cards.getCard(getRank(flop1Value), getSuit(flop1Suit));
            pc.addCommunityCard(Cards.getCard(getRank(flop1Value),
                    getSuit(flop1Suit)));
        });
        ...
        flop2Suit.addActionListener((ActionEvent e) -> {
            ...
            flop[1] = Cards.getCard(getRank(flop2Value), getSuit(flop2Suit));
            pc.addCommunityCard(Cards.getCard(getRank(flop2Value),
                    getSuit(flop2Suit)));
        });
        ...
        flop3Suit.addActionListener((ActionEvent e) -> {
            ...
            flop[2] = Cards.getCard(getRank(flop3Value), getSuit(flop3Suit));
            pc.addCommunityCard(Cards.getCard(getRank(flop3Value),
                    getSuit(flop3Suit)));
        });
        ...
        riverSuit.addActionListener((ActionEvent e) -> {
            ...
            r = Cards.getCard(getRank(riverValue), getSuit(riverSuit));
            pc.addCommunityCard(Cards.getCard(getRank(riverValue),
                    getSuit(riverSuit)));
        });
        ...
        turnSuit.addActionListener((ActionEvent e) -> {
            ...
            t = Cards.getCard(getRank(turnValue), getSuit(turnSuit));
            pc.addCommunityCard(Cards.getCard(getRank(turnValue),
                    getSuit(turnSuit)));
        });
    ...
    void makeDiaryEntry(int num) {
        ...
        switch (num) {
            case 1:
                player1Card1 = player1Card1Value + " " + player1Card1Suit;
                player1Card2 = player1Card2Value + "" + player1Card2Suit;
                break;
            case 2:
                player1Card1 = player1Card1Value + " " + player1Card1Suit;
                player1Card2 = player1Card2Value + "" + player1Card2Suit;
                player2Card1 = player2Card1Value + " " + player2Card1Suit;
                player2Card2 = player2Card2Value + "" + player2Card2Suit;
                break;
            case 3:
                player1Card1 = player1Card1Value + " " + player1Card1Suit;
                player1Card2 = player1Card2Value + "" + player1Card2Suit;
                player2Card1 = player2Card1Value + " " + player2Card1Suit;
                player2Card2 = player2Card2Value + "" + player2Card2Suit;
                player3Card1 = player3Card1Value + " " + player3Card1Suit;
                player3Card2 = player3Card2Value + "" + player3Card2Suit;
                break;
            case 4:
                player1Card1 = player1Card1Value + " " + player1Card1Suit;
                player1Card2 = player1Card2Value + "" + player1Card2Suit;
                ...
                player3Card1 = player3Card1Value + " " + player3Card1Suit;
                player3Card2 = player3Card2Value + "" + player3Card2Suit;
                player4Card1 = player4Card1Value + " " + player4Card1Suit;
                player4Card2 = player4Card2Value + "" + player4Card2Suit;
                break;
            case 5:
                player1Card1 = player1Card1Value + " " + player1Card1Suit;
                player1Card2 = player1Card2Value + "" + player1Card2Suit;
                ...
                player4Card1 = player4Card1Value + " " + player4Card1Suit;
                player4Card2 = player4Card2Value + "" + player4Card2Suit;
                player5Card1 = player5Card1Value + " " + player5Card1Suit;
                player5Card2 = player5Card2Value + "" + player5Card2Suit;
                break;
            case 6:
                player1Card1 = player1Card1Value + " " + player1Card1Suit;
                player1Card2 = player1Card2Value + "" + player1Card2Suit;
                ...
                player5Card1 = player5Card1Value + " " + player5Card1Suit;
                player5Card2 = player5Card2Value + "" + player5Card2Suit;
                player6Card1 = player6Card1Value + " " + player6Card1Suit;
                player6Card2 = player6Card2Value + "" + player6Card2Suit;
                break;
            case 7:
                player1Card1 = player1Card1Value + " " + player1Card1Suit;
                player1Card2 = player1Card2Value + "" + player1Card2Suit;
                ...
                player6Card1 = player6Card1Value + " " + player6Card1Suit;
                player6Card2 = player6Card2Value + "" + player6Card2Suit;
                player7Card1 = player7Card1Value + " " + player7Card1Suit;
                player7Card2 = player7Card2Value + "" + player7Card2Suit;
                break;
            case 8:
                player1Card1 = player1Card1Value + " " + player1Card1Suit;
                player1Card2 = player1Card2Value + "" + player1Card2Suit;
                ...
                player7Card1 = player7Card1Value + " " + player7Card1Suit;
                player7Card2 = player7Card2Value + "" + player7Card2Suit;
                player8Card1 = player8Card1Value + " " + player8Card1Suit;
                player8Card2 = player8Card2Value + "" + player8Card2Suit;
        ...
        boxSuit1.addActionListener((ActionEvent e) -> {
            ...
            switch (num) {
                case 1:
                    ...
                    p1Cards.add(Cards.getCard(getRank(boxValue1),
                            getSuit(boxSuit1)));
                    pc.addUserCard(Cards.getCard(getRank(boxValue1),
                            getSuit(boxSuit1)));
                    break;
                case 2:
                    player2Card1Suit = boxSuit1.getSelectedItem().toString();
                    p2Cards.add(Cards.getCard(getRank(boxValue1),
                            getSuit(boxSuit1)));
                    break;
                case 3:
        ...
        boxSuit2.addActionListener((ActionEvent e) -> {
            ...
            switch (num) {
                case 1:
                    ...
                    p1Cards.add(Cards.getCard(getRank(boxValue2),
                            getSuit(boxSuit2)));
                    pc.addUserCard(Cards.getCard(getRank(boxValue2),
                            getSuit(boxSuit2)));
                    break;
                case 2:
                    player2Card2Value = boxSuit2.getSelectedItem().toString();
                    p2Cards.add(Cards.getCard(getRank(boxValue2),
                            getSuit(boxSuit2)));
                    break;
                case 3:
    ...
    private JTable updateTable(String odd, String needed,
            String[] column, int width, int height) {
        //Calculation Panel
        String[][] dataRow = {{odd, needed}, {"", ""}};
        JTable calcTable = new JTable(dataRow, column);
        calcTable.setPreferredScrollableViewportSize(calcTable.getPreferredSize());
        calcTable.setSize(width, height);
        return calcTable;
    }

    private Suit getSuit(JComboBox box) {
        return Suit.valueOf(box.getSelectedItem().toString());
    }

    private Rank getRank(JComboBox box) {
        return Rank.valueOf(box.getSelectedItem().toString());
    }
