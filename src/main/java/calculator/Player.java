...
public class Player {
    ...
    private final static Logger PLAYERLOGGER = Logger.
    ...
    /**
     * Constructor given database id and name. Assumes that the record already
     * exists as given in the database.
     *
    ...
    public static Player findById(int id) {
        ...
        try {
            ...
            PLAYERLOGGER.log(Level.FINE, "Find player by ID error", ex);
        }
    ...
    public boolean save() {
        ...
        try {
            ...
            PLAYERLOGGER.log(Level.FINE, "Save player error", ex);
        }
    ...
    public boolean update() {
        ...
        try {
            ...
            PLAYERLOGGER.log(Level.FINE, "Update player error", ex);
        }
